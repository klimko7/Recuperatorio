...
public class RecuperatorioPPKlimkowskiIvan {
    ...
    // PRODUCTOS
    Pizza p1 = new Pizza("Napolitana Clasica", 2500, f1, TipoPizza.NAPOLITANA, TamañoPizza.GRANDE);
    Pizza p2 = new Pizza("Muzza de la Casa", 2200, f2, TipoPizza.MUZZARELLA,
    TamañoPizza.MEDIANA);
    Pizza p3 = new Pizza("Calabresa Picante", 2300, f1, TipoPizza.CALABRESA, TamañoPizza.CHICA);
    ...
    Pizza p4 = new Pizza("Napolitana Clasica", 2500, f1, TipoPizza.NAPOLITANA, TamañoPizza.GRANDE);
    pizzeria.agregar(p4);
    pizzeria.agregar(d3);
    pizzeria.agregar(p2);
    pizzeria.agregar(p3);
